...
Personal config files for my development environment.

## Shell
- [Zsh](https://www.zsh.org) - see my config [here](zsh/.zshrc).
...
## WSL
- [WSL](https://learn.microsoft.com/en-us/windows/wsl/) - see my config [here](wsl/.wslconfig).

## Dev Tools
- [Mise](https://mise.jdx.dev) - see my config [here](mise/mise.toml).
